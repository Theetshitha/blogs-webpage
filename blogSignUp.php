...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if ($conn->connect_error){
    die($conn->connect_error."Connection failed");
  }

  $sqlInsert="INSERT INTO UserDetails (name,email,password) VALUES ('$username','$Email','$Password')";
  ...
  if($conn->query($sqlInsert) == TRUE){
    ...
    echo "You have some issues, you can't add your records";
  }
$conn->close();
  ...
  <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <a href="index.php">BACK TO HOME</a>
     ...
     Already have an Account? 
      <a href="blogLogin.php" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Login in to Theetshi's Blog</a>
    </p>
  </div>
</div>
